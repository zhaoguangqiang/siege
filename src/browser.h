...
void     browser_set_interval_time(BROWSER this, unsigned int interval_time);
void     browser_set_cookies(BROWSER this, HASH cookies);
unsigned long browser_get_hits(BROWSER this);
unsigned int browser_get_hits_array_num(BROWSER this);
unsigned int *browser_get_hits_array(BROWSER this);
